...
# Function to compute MFCCs with delta and delta-delta, and silence trimming
def load_mfcc(path, n_mfcc=13):
    ...
    # Add delta (1st derivative) and delta-delta (2nd derivative)
    delta = librosa.feature.delta(mfcc)
    delta2 = librosa.feature.delta(mfcc, order=2)

    # Stack all features: shape becomes (n_mfcc * 3, time)
...
for dataset in datasets:
    ...
    for i in range(1, num_pairs + 1):
        ...
        # Load MFCCs (with silence trimmed + deltas)
